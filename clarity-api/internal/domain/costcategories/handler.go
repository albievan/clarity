...
// Handler holds the HTTP handler functions for the costcategories domain.
type Handler struct {
	svc Service
}
...
// Get handles GET /costcategories/{id}.
...
// Create handles POST /costcategories.
...
// Update handles PUT /costcategories/{id}.
...
// Delete handles DELETE /costcategories/{id}.
