...
// Get handles GET /budgetlines/{id}.
...
// Create handles POST /budgetlines.
...
// Update handles PUT /budgetlines/{id}.
...
// Delete handles DELETE /budgetlines/{id}.
...
// ListDocuments handles the ListDocuments action.
func (h *Handler) ListDocuments(w http.ResponseWriter, r *http.Request) {
	// TODO: implement ListDocuments
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "ListDocuments not yet implemented"})
}

// UploadDocument handles the UploadDocument action.
func (h *Handler) UploadDocument(w http.ResponseWriter, r *http.Request) {
	// TODO: implement UploadDocument
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "UploadDocument not yet implemented"})
}
