...
// Handler holds the HTTP handler functions for the actuals domain.
type Handler struct {
	svc Service
}
...
// Delete handles DELETE /actuals/{id}.
...
// Amend handles the Amend action.
func (h *Handler) Amend(w http.ResponseWriter, r *http.Request) {
	// TODO: implement Amend
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "Amend not yet implemented"})
}

// BulkImport handles the BulkImport action.
func (h *Handler) BulkImport(w http.ResponseWriter, r *http.Request) {
	// TODO: implement BulkImport
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "BulkImport not yet implemented"})
}

// BulkImportStatus handles the BulkImportStatus action.
func (h *Handler) BulkImportStatus(w http.ResponseWriter, r *http.Request) {
	// TODO: implement BulkImportStatus
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "BulkImportStatus not yet implemented"})
}
