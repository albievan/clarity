...
// Handler holds the HTTP handler functions for the forecasts domain.
type Handler struct {
	svc Service
}
...
// Update handles PUT /forecasts/{id}.
...
// Delete handles DELETE /forecasts/{id}.
