...
// Handler holds the HTTP handler functions for the departments domain.
type Handler struct {
	svc Service
}
...
// Archive handles the Archive action.
func (h *Handler) Archive(w http.ResponseWriter, r *http.Request) {
	// TODO: implement Archive
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "Archive not yet implemented"})
}
