...
// Handler holds the HTTP handler functions for the agreements domain.
type Handler struct {
	svc Service
}
...
// Create handles POST /agreements.
...
// Update handles PUT /agreements/{id}.
...
// Delete handles DELETE /agreements/{id}.
...
// Cancel handles the Cancel action.
func (h *Handler) Cancel(w http.ResponseWriter, r *http.Request) {
	// TODO: implement Cancel
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "Cancel not yet implemented"})
}

// ListAlerts handles the ListAlerts action.
func (h *Handler) ListAlerts(w http.ResponseWriter, r *http.Request) {
	// TODO: implement ListAlerts
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "ListAlerts not yet implemented"})
}

// AcknowledgeAlert handles the AcknowledgeAlert action.
func (h *Handler) AcknowledgeAlert(w http.ResponseWriter, r *http.Request) {
	// TODO: implement AcknowledgeAlert
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "AcknowledgeAlert not yet implemented"})
}
