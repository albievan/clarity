...
// Service defines the business logic contract for the budgets domain.
type Service interface {
	List(ctx context.Context, tenantID, userID string, page, perPage int) ([]Budget, int, error)
	Get(ctx context.Context, tenantID, userID, id string) (*Budget, error)
	Create(ctx context.Context, tenantID, userID string, req CreateRequest) (*Budget, error)
	Update(ctx context.Context, tenantID, userID, id string, req UpdateRequest) (*Budget, error)
...
func (s *service) List(ctx context.Context, tenantID, userID string, page, perPage int) ([]Budget, int, error) {
	// TODO: apply role-based visibility before calling repo
	return s.repo.List(ctx, tenantID, page, perPage)
}

func (s *service) Get(ctx context.Context, tenantID, userID, id string) (*Budget, error) {
...
func (s *service) Update(ctx context.Context, tenantID, userID, id string, req UpdateRequest) (*Budget, error) {
