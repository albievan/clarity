...
// Handler holds the HTTP handler functions for the budgets domain.
type Handler struct {
	svc Service
}
...
// Return handles the Return action.
func (h *Handler) Return(w http.ResponseWriter, r *http.Request) {
	// TODO: implement Return
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "Return not yet implemented"})
}

// TPIConfirm handles the TPIConfirm action.
func (h *Handler) TPIConfirm(w http.ResponseWriter, r *http.Request) {
	// TODO: implement TPIConfirm
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "TPIConfirm not yet implemented"})
}
