...
// Handler holds the HTTP handler functions for the costcentres domain.
type Handler struct {
	svc Service
}
...
// Get handles GET /costcentres/{id}.
...
// Create handles POST /costcentres.
...
// Update handles PUT /costcentres/{id}.
...
// Delete handles DELETE /costcentres/{id}.
