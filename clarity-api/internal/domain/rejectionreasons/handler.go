...
// Handler holds the HTTP handler functions for the rejectionreasons domain.
type Handler struct {
	svc Service
}
...
// Get handles GET /rejectionreasons/{id}.
...
// Create handles POST /rejectionreasons.
...
// Update handles PUT /rejectionreasons/{id}.
...
// Delete handles DELETE /rejectionreasons/{id}.
