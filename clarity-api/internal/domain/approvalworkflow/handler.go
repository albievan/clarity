...
// Handler holds the HTTP handler functions for the approvalworkflow domain.
type Handler struct {
	svc Service
}
...
// Get handles GET /approvalworkflow/{id}.
...
// Create handles POST /approvalworkflow.
...
// Update handles PUT /approvalworkflow/{id}.
...
// Delete handles DELETE /approvalworkflow/{id}.
...
// Deactivate handles the Deactivate action.
func (h *Handler) Deactivate(w http.ResponseWriter, r *http.Request) {
	// TODO: implement Deactivate
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "Deactivate not yet implemented"})
}

// PendingApprovals handles the PendingApprovals action.
func (h *Handler) PendingApprovals(w http.ResponseWriter, r *http.Request) {
	// TODO: implement PendingApprovals
	response.JSON(w, http.StatusNotImplemented, map[string]string{"message": "PendingApprovals not yet implemented"})
}
